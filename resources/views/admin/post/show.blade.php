                        ...
                        <table class="table table-bordered table-pimary">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div style="max-width: 400px; max-height:100%;overflow:hidden">
                                ...
                                <tr>
                                    <th style="width: 200px">Cooking Step</th>
                                    <td>{!! $post->cooking_step !!}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th style="width: 200px">Cooking Time</th>
                                    <td>{!! $post->cooking_time !!}</td>
                                </tr>
