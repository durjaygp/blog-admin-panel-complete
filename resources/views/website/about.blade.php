...
<section class="pt-4">
	<div class="container">
		<div class="row">
      <div class="col-12">
        <div class="card bg-dark-overlay-4 overflow-hidden card-bg-scale h-400 text-center" style="background-image:url({{asset('website')}}/images/blog/16by9/09.jpg); background-position: center left; background-size: cover;">
          <!-- Card Image overlay -->
      ...
      <div class="col-xl-9 mx-auto">
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="text-center">
            	<!-- Avatar img -->
              <div class="avatar avatar-xxl mb-2">
                <img class="avatar-img rounded-circle" src="{{asset('website')}}/images/avatar/14.jpg" alt="avatar">
              </div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="text-center">
            	<!-- Avatar img -->
              <div class="avatar avatar-xxl mb-2">
                <img class="avatar-img rounded-circle" src="{{asset('website')}}/images/avatar/10.jpg" alt="avatar">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <img class="rounded" src="{{asset('website')}}/images/blog/3by2/04.jpg" alt="Card image">
          ...
          <!-- Service item-->
          <div class="col-md-6 col-lg-4 mb-4">
            <img class="rounded" src="{{asset('website')}}/images/blog/3by2/01.jpg" alt="Card image">
          ...
          <!-- Service item-->
          <div class="col-md-6 col-lg-4 mb-4">
            <img class="rounded" src="{{asset('website')}}/images/blog/3by2/03.jpg" alt="Card image">
