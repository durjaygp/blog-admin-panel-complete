		...
		<div class="row">
      	...
      	<p><span class="dropcap">M</span>oonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing although the material does the exercise of. Up attempt offered ye civilly so sitting to. She new course gets living within Elinor joy. She rapturous suffering concealed. </p>
				...
				<figure class="figure mt-2">
				  <a href="{{asset('website')}}/images/blog/3by2/04.jpg" data-glightbox data-gallery="image-popup">
		      	<img class="rounded" src="{{asset('website')}}/images/blog/3by2/04.jpg" alt="Image">
		       </a>
				...
				<div class="row">
					<div class="col-md-6 mb-4">
						<a href="{{asset('website')}}/images/blog/4by3/03.jpg" data-glightbox data-gallery="image-popup">
			      	<img class="rounded" src="{{asset('website')}}/images/blog/4by3/03.jpg" alt="Image">
			       </a>
					</div>
					<div class="col-md-6 mb-4">
						<a href="{{asset('website')}}/images/blog/4by3/04.jpg" data-glightbox data-gallery="image-popup">
			      	<img class="rounded" src="{{asset('website')}}/images/blog/4by3/04.jpg" alt="Image">
			       </a>
					</div>
				</div>
				...
				<div class="mx-auto w-100 d-flex justify-content-center my-5">
					<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Bootstrap 5 Beta 3 is here! We’ve added a new offcanvas component, four new examples, numbered list groups, added new Sass docs to each component, fixed bugs, and more!<a href="https://t.co/ElHfhkcV3w">https://t.co/ElHfhkcV3w</a></p>&mdash; Bootstrap (@getbootstrap) <a href="https://twitter.com/getbootstrap/status/1374404289586589701?ref_src=twsrc%5Etfw">March 23, 2021</a></blockquote> <script async src="../platform.twitter.com/widgets.js" charset="utf-8"></script>
				</div>
					...
					<div class="tiny-slider arrow-hover arrow-blur arrow-white arrow-round">
						<div class="tiny-slider-inner"
							...
							<div class="card">
								<!-- Card img -->
								<div class="position-relative">
									<img class="card-img" src="{{asset('website')}}/images/blog/4by3/07.jpg" alt="Card image">
											...
											<div class="nav-link">
												<div class="d-flex align-items-center position-relative">
													<div class="avatar avatar-xs">
														<img class="avatar-img rounded-circle" src="{{asset('website')}}/images/avatar/07.jpg" alt="avatar">
													</div>
							...
							<div class="card">
								<!-- Card img -->
								<div class="position-relative">
									<img class="card-img" src="{{asset('website')}}/images/blog/4by3/08.jpg" alt="Card image">
									<div class="card-img-overlay d-flex align-items-start flex-column p-3">
										<!-- Card overlay bottom -->
										<div class="w-100 mt-auto">
									...
									<ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
										<li class="nav-item">
											<div class="nav-link">
												<div class="d-flex align-items-center position-relative">
													<div class="avatar avatar-xs">
														<img class="avatar-img rounded-circle" src="{{asset('website')}}/images/avatar/08.jpg" alt="avatar">
													</div>
							...
							<div class="card">
								<!-- Card img -->
								<div class="position-relative">
									<img class="card-img" src="{{asset('website')}}/images/blog/4by3/09.jpg" alt="Card image">
									<div class="card-img-overlay d-flex align-items-start flex-column p-3">
										<!-- Card overlay bottom -->
										<div class="w-100 mt-auto">
									...
									<ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
										<li class="nav-item">
											<div class="nav-link">
												<div class="d-flex align-items-center position-relative">
													<div class="avatar avatar-xs">
														<img class="avatar-img rounded-circle" src="{{asset('website')}}/images/avatar/09.jpg" alt="avatar">
													</div>
				...
				<div>
					...
					<div class="my-4 d-flex">
					  <img class="avatar avatar-md rounded-circle float-start me-3" src="{{asset('website')}}/images/avatar/01.jpg" alt="avatar">
					  <div>
					    <div class="mb-2">
						...
						<div class="my-4 d-flex ps-2 ps-md-3">
						  <img class="avatar avatar-md rounded-circle float-start me-3" src="{{asset('website')}}/images/avatar/02.jpg" alt="avatar">
						  <div>
						    <div class="mb-2">
						...
						<!-- Comment level 2 -->
						<div class="my-4 d-flex ps-2 ps-md-3">
						  <img class="avatar avatar-md rounded-circle float-start me-3" src="{{asset('website')}}/images/avatar/03.jpg" alt="avatar">
						  <div>
						    <div class="mb-2">
					...
					<!-- Comment level 1 -->
					<div class="my-4 d-flex">
					  <img class="avatar avatar-md rounded-circle float-start me-3" src="{{asset('website')}}/images/avatar/04.jpg" alt="avatar">
					  <div>
					    <div class="mb-2">
				  ...
				  <li>hello there how are you</li>
					...
					<div class="mt-4">
						<a href="#" class="d-block card-img-flash">
							<img src="{{asset('website')}}/images/adv.png" alt="">
						</a>
					</div>
				</div>
			</div>
...
<div class="sticky-post bg-light border p-4 mb-5 text-sm-end rounded d-none d-xxl-block">
  <div class="d-flex align-items-center">
    ...
    <div class="col-4 d-none d-md-block">
      <img src="{{asset('website')}}/images/blog/4by3/05.jpg" alt="Image">
    </div>
  </div>
</div>
<!-- =======================
